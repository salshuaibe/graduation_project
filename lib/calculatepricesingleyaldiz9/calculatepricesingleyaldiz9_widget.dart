...
class Calculatepricesingleyaldiz9Widget extends StatefulWidget {
  Calculatepricesingleyaldiz9Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz9WidgetState createState() =>
      _Calculatepricesingleyaldiz9WidgetState();
}

class _Calculatepricesingleyaldiz9WidgetState
    extends State<Calculatepricesingleyaldiz9Widget> {
