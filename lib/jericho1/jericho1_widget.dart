...
import '../jericomap/jericomap_widget.dart';
import '../palestiniancity/palestiniancity_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

class Jericho1Widget extends StatefulWidget {
  Jericho1Widget({Key key}) : super(key: key);

  @override
  _Jericho1WidgetState createState() => _Jericho1WidgetState();
}

class _Jericho1WidgetState extends State<Jericho1Widget> {
                                ...
                                IconButton(
                                  onPressed: () async {
                                    await Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => JericomapWidget(),
                                      ),
                                    );
                                  },
                                  icon: Icon(
