...
class Calculatepricesingleyaldiz16Widget extends StatefulWidget {
  Calculatepricesingleyaldiz16Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz16WidgetState createState() =>
      _Calculatepricesingleyaldiz16WidgetState();
}

class _Calculatepricesingleyaldiz16WidgetState
    extends State<Calculatepricesingleyaldiz16Widget> {
