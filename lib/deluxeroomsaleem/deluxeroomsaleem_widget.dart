import '../calculatepricesingleyaldiz16/calculatepricesingleyaldiz16_widget.dart';
...
class DeluxeroomsaleemWidget extends StatefulWidget {
  DeluxeroomsaleemWidget({Key key}) : super(key: key);

  @override
  _DeluxeroomsaleemWidgetState createState() => _DeluxeroomsaleemWidgetState();
}

class _DeluxeroomsaleemWidgetState extends State<DeluxeroomsaleemWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz16Widget(),
                  ),
                );
              },
              child: Icon(
            ...
            children: [
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      Image.asset(
                                        'assets/images/78258366.jpg',
                                        width: 60,
                                        height: 600,
                                        fit: BoxFit.contain,
                                      ),
                                      Image.asset(
                                        'assets/images/78258380 (1).jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542551.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542552.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542553.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    'one single bed Or one extra large double bed',
