...
class Calculatepricesingleyaldiz46Widget extends StatefulWidget {
  Calculatepricesingleyaldiz46Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz46WidgetState createState() =>
      _Calculatepricesingleyaldiz46WidgetState();
}

class _Calculatepricesingleyaldiz46WidgetState
    extends State<Calculatepricesingleyaldiz46Widget> {
        ...
        leading: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => StandardDoubleRoomcityinWidget(),
              ),
            );
          },
          child: Icon(
