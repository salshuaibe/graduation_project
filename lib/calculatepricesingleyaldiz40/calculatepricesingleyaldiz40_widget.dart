...
class Calculatepricesingleyaldiz40Widget extends StatefulWidget {
  Calculatepricesingleyaldiz40Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz40WidgetState createState() =>
      _Calculatepricesingleyaldiz40WidgetState();
}

class _Calculatepricesingleyaldiz40WidgetState
    extends State<Calculatepricesingleyaldiz40Widget> {
        ...
        leading: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => Bedin4BedFemaleDormitoryRoomWidget(),
              ),
            );
          },
          child: Icon(
