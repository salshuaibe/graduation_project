...
class CheckavailabilitycasablancaWidget extends StatefulWidget {
  CheckavailabilitycasablancaWidget({Key key}) : super(key: key);

  @override
  _CheckavailabilitycasablancaWidgetState createState() =>
      _CheckavailabilitycasablancaWidgetState();
}

class _CheckavailabilitycasablancaWidgetState
    extends State<CheckavailabilitycasablancaWidget> {
