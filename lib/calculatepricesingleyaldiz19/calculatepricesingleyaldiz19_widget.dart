...
class Calculatepricesingleyaldiz19Widget extends StatefulWidget {
  Calculatepricesingleyaldiz19Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz19WidgetState createState() =>
      _Calculatepricesingleyaldiz19WidgetState();
}

class _Calculatepricesingleyaldiz19WidgetState
    extends State<Calculatepricesingleyaldiz19Widget> {
