...
class Calculatepricesingleyaldiz49Widget extends StatefulWidget {
  Calculatepricesingleyaldiz49Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz49WidgetState createState() =>
      _Calculatepricesingleyaldiz49WidgetState();
}

class _Calculatepricesingleyaldiz49WidgetState
    extends State<Calculatepricesingleyaldiz49Widget> {
