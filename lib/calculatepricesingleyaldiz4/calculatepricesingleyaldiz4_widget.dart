...
class Calculatepricesingleyaldiz4Widget extends StatefulWidget {
  Calculatepricesingleyaldiz4Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz4WidgetState createState() =>
      _Calculatepricesingleyaldiz4WidgetState();
}

class _Calculatepricesingleyaldiz4WidgetState
    extends State<Calculatepricesingleyaldiz4Widget> {
