...
import '../calculatepricesingleyaldiz18/calculatepricesingleyaldiz18_widget.dart';
...
class AlyasmeenBudgetDoubleRoomWidget extends StatefulWidget {
  AlyasmeenBudgetDoubleRoomWidget({Key key}) : super(key: key);

  @override
  _AlyasmeenBudgetDoubleRoomWidgetState createState() =>
      _AlyasmeenBudgetDoubleRoomWidgetState();
}

class _AlyasmeenBudgetDoubleRoomWidgetState
    extends State<AlyasmeenBudgetDoubleRoomWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz18Widget(),
                  ),
                );
              },
              child: Icon(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      Image.asset(
                                        'assets/images/37752799.jpg',
                                        width: 60,
                                        height: 600,
                                        fit: BoxFit.contain,
                                      ),
                                      Image.asset(
                                        'assets/images/116687834.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/137906687.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/137906705.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      )
