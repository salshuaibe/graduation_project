...
class Calculatepricesingleyaldiz21Widget extends StatefulWidget {
  Calculatepricesingleyaldiz21Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz21WidgetState createState() =>
      _Calculatepricesingleyaldiz21WidgetState();
}

class _Calculatepricesingleyaldiz21WidgetState
    extends State<Calculatepricesingleyaldiz21Widget> {
