...
class Calculatepricesingleyaldiz10Widget extends StatefulWidget {
  Calculatepricesingleyaldiz10Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz10WidgetState createState() =>
      _Calculatepricesingleyaldiz10WidgetState();
}

class _Calculatepricesingleyaldiz10WidgetState
    extends State<Calculatepricesingleyaldiz10Widget> {
