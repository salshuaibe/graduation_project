...
class Calculatepricesingleyaldiz1Widget extends StatefulWidget {
  Calculatepricesingleyaldiz1Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz1WidgetState createState() =>
      _Calculatepricesingleyaldiz1WidgetState();
}

class _Calculatepricesingleyaldiz1WidgetState
    extends State<Calculatepricesingleyaldiz1Widget> {
