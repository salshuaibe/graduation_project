...
class Calculatepricesingleyaldiz35Widget extends StatefulWidget {
  Calculatepricesingleyaldiz35Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz35WidgetState createState() =>
      _Calculatepricesingleyaldiz35WidgetState();
}

class _Calculatepricesingleyaldiz35WidgetState
    extends State<Calculatepricesingleyaldiz35Widget> {
