...
class CheckavailabilitycitinnWidget extends StatefulWidget {
  CheckavailabilitycitinnWidget({Key key}) : super(key: key);

  @override
  _CheckavailabilitycitinnWidgetState createState() =>
      _CheckavailabilitycitinnWidgetState();
}

class _CheckavailabilitycitinnWidgetState
    extends State<CheckavailabilitycitinnWidget> {
