...
class Calculatepricesingleyaldiz3Widget extends StatefulWidget {
  Calculatepricesingleyaldiz3Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz3WidgetState createState() =>
      _Calculatepricesingleyaldiz3WidgetState();
}

class _Calculatepricesingleyaldiz3WidgetState
    extends State<Calculatepricesingleyaldiz3Widget> {
