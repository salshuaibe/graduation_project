...
class Calculatepricesingleyaldiz2Widget extends StatefulWidget {
  Calculatepricesingleyaldiz2Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz2WidgetState createState() =>
      _Calculatepricesingleyaldiz2WidgetState();
}

class _Calculatepricesingleyaldiz2WidgetState
    extends State<Calculatepricesingleyaldiz2Widget> {
