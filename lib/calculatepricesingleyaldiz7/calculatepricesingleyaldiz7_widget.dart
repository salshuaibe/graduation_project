...
class Calculatepricesingleyaldiz7Widget extends StatefulWidget {
  Calculatepricesingleyaldiz7Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz7WidgetState createState() =>
      _Calculatepricesingleyaldiz7WidgetState();
}

class _Calculatepricesingleyaldiz7WidgetState
    extends State<Calculatepricesingleyaldiz7Widget> {
