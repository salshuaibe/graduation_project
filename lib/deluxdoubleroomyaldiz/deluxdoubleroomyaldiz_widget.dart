import '../calculatepricesingleyaldiz1/calculatepricesingleyaldiz1_widget.dart';
...
class DeluxdoubleroomyaldizWidget extends StatefulWidget {
  DeluxdoubleroomyaldizWidget({Key key}) : super(key: key);

  @override
  _DeluxdoubleroomyaldizWidgetState createState() =>
      _DeluxdoubleroomyaldizWidgetState();
}

class _DeluxdoubleroomyaldizWidgetState
    extends State<DeluxdoubleroomyaldizWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz1Widget(),
                  ),
                );
              },
              child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/219356805.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356955.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356979.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
