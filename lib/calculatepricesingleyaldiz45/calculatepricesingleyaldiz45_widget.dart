...
class Calculatepricesingleyaldiz45Widget extends StatefulWidget {
  Calculatepricesingleyaldiz45Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz45WidgetState createState() =>
      _Calculatepricesingleyaldiz45WidgetState();
}

class _Calculatepricesingleyaldiz45WidgetState
    extends State<Calculatepricesingleyaldiz45Widget> {
