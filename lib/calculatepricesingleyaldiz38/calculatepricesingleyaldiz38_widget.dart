...
class Calculatepricesingleyaldiz38Widget extends StatefulWidget {
  Calculatepricesingleyaldiz38Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz38WidgetState createState() =>
      _Calculatepricesingleyaldiz38WidgetState();
}

class _Calculatepricesingleyaldiz38WidgetState
    extends State<Calculatepricesingleyaldiz38Widget> {
        ...
        leading: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => StandardTwinRoomcasblancaWidget(),
              ),
            );
          },
          child: Icon(
