...
class CheckavailabilityBethlehemhoteWidget extends StatefulWidget {
  CheckavailabilityBethlehemhoteWidget({Key key}) : super(key: key);

  @override
  _CheckavailabilityBethlehemhoteWidgetState createState() =>
      _CheckavailabilityBethlehemhoteWidgetState();
}

class _CheckavailabilityBethlehemhoteWidgetState
    extends State<CheckavailabilityBethlehemhoteWidget> {
