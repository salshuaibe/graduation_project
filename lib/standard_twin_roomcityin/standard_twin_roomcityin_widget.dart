...
class StandardTwinRoomcityinWidget extends StatefulWidget {
  StandardTwinRoomcityinWidget({Key key}) : super(key: key);

  @override
  _StandardTwinRoomcityinWidgetState createState() =>
      _StandardTwinRoomcityinWidgetState();
}

class _StandardTwinRoomcityinWidgetState
    extends State<StandardTwinRoomcityinWidget> {
