...
class Calculatepricesingleyaldiz6Widget extends StatefulWidget {
  Calculatepricesingleyaldiz6Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz6WidgetState createState() =>
      _Calculatepricesingleyaldiz6WidgetState();
}

class _Calculatepricesingleyaldiz6WidgetState
    extends State<Calculatepricesingleyaldiz6Widget> {
