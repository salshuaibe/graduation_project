import '../calculatepricesingleyaldiz6/calculatepricesingleyaldiz6_widget.dart';
...
class KingsuitedeluxWidget extends StatefulWidget {
  KingsuitedeluxWidget({Key key}) : super(key: key);

  @override
  _KingsuitedeluxWidgetState createState() => _KingsuitedeluxWidgetState();
}

class _KingsuitedeluxWidgetState extends State<KingsuitedeluxWidget> {
          ...
          InkWell(
            onTap: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Calculatepricesingleyaldiz6Widget(),
                ),
              );
            },
            child: Icon(
