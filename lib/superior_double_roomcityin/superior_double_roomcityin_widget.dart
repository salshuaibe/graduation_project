import '../calculatepricesingleyaldiz48/calculatepricesingleyaldiz48_widget.dart';
...
class SuperiorDoubleRoomcityinWidget extends StatefulWidget {
  SuperiorDoubleRoomcityinWidget({Key key}) : super(key: key);

  @override
  _SuperiorDoubleRoomcityinWidgetState createState() =>
      _SuperiorDoubleRoomcityinWidgetState();
}

class _SuperiorDoubleRoomcityinWidgetState
    extends State<SuperiorDoubleRoomcityinWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz48Widget(),
                  ),
                );
              },
              child: Icon(
