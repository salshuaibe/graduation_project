import '../calculatepricesingleyaldiz5/calculatepricesingleyaldiz5_widget.dart';
...
class DeluxeKingSuitewithbalconyWidget extends StatefulWidget {
  DeluxeKingSuitewithbalconyWidget({Key key}) : super(key: key);

  @override
  _DeluxeKingSuitewithbalconyWidgetState createState() =>
      _DeluxeKingSuitewithbalconyWidgetState();
}

class _DeluxeKingSuitewithbalconyWidgetState
    extends State<DeluxeKingSuitewithbalconyWidget> {
          ...
          InkWell(
            onTap: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Calculatepricesingleyaldiz5Widget(),
                ),
              );
            },
            child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/219356753.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356697.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356967.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
