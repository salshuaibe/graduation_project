import '../calculatepricesingleyaldiz4/calculatepricesingleyaldiz4_widget.dart';
...
class SuperiorKingSuiteWidget extends StatefulWidget {
  SuperiorKingSuiteWidget({Key key}) : super(key: key);

  @override
  _SuperiorKingSuiteWidgetState createState() =>
      _SuperiorKingSuiteWidgetState();
}

class _SuperiorKingSuiteWidgetState extends State<SuperiorKingSuiteWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz4Widget(),
                  ),
                );
              },
              child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/219356706.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356672.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
