...
class CheckavailabilityyasmeenWidget extends StatefulWidget {
  CheckavailabilityyasmeenWidget({Key key}) : super(key: key);

  @override
  _CheckavailabilityyasmeenWidgetState createState() =>
      _CheckavailabilityyasmeenWidgetState();
}

class _CheckavailabilityyasmeenWidgetState
    extends State<CheckavailabilityyasmeenWidget> {
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.fromLTRB(4, 10, 0, 20),
                                child: Container(
                                  width: 300,
                                  height: 50,
                                  decoration: BoxDecoration(
