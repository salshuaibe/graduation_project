...
class Calculatepricesingleyaldiz39Widget extends StatefulWidget {
  Calculatepricesingleyaldiz39Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz39WidgetState createState() =>
      _Calculatepricesingleyaldiz39WidgetState();
}

class _Calculatepricesingleyaldiz39WidgetState
    extends State<Calculatepricesingleyaldiz39Widget> {
        ...
        leading: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => StandardQuadrupleRoomcasablancaWidget(),
              ),
            );
          },
          child: Icon(
