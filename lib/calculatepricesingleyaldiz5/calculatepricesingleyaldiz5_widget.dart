...
class Calculatepricesingleyaldiz5Widget extends StatefulWidget {
  Calculatepricesingleyaldiz5Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz5WidgetState createState() =>
      _Calculatepricesingleyaldiz5WidgetState();
}

class _Calculatepricesingleyaldiz5WidgetState
    extends State<Calculatepricesingleyaldiz5Widget> {
        ...
        leading: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DeluxeKingSuitewithbalconyWidget(),
              ),
            );
          },
          child: Icon(
