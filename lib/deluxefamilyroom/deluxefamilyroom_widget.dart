import '../calculatepricesingleyaldiz10/calculatepricesingleyaldiz10_widget.dart';
...
class DeluxefamilyroomWidget extends StatefulWidget {
  DeluxefamilyroomWidget({Key key}) : super(key: key);

  @override
  _DeluxefamilyroomWidgetState createState() => _DeluxefamilyroomWidgetState();
}

class _DeluxefamilyroomWidgetState extends State<DeluxefamilyroomWidget> {
          ...
          InkWell(
            onTap: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Calculatepricesingleyaldiz10Widget(),
                ),
              );
            },
            child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/219721476.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356742.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
