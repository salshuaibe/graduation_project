import '../calculatepricesingleyaldiz45/calculatepricesingleyaldiz45_widget.dart';
...
class DeluxeRoomcityinnWidget extends StatefulWidget {
  DeluxeRoomcityinnWidget({Key key}) : super(key: key);

  @override
  _DeluxeRoomcityinnWidgetState createState() =>
      _DeluxeRoomcityinnWidgetState();
}

class _DeluxeRoomcityinnWidgetState extends State<DeluxeRoomcityinnWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz45Widget(),
                  ),
                );
              },
              child: Icon(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      Image.asset(
                                        'assets/images/72447912.jpg',
                                        width: 60,
                                        height: 600,
                                        fit: BoxFit.contain,
                                      ),
                                      Image.asset(
                                        'assets/images/72448370.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
