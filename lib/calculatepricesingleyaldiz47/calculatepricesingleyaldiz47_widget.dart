...
class Calculatepricesingleyaldiz47Widget extends StatefulWidget {
  Calculatepricesingleyaldiz47Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz47WidgetState createState() =>
      _Calculatepricesingleyaldiz47WidgetState();
}

class _Calculatepricesingleyaldiz47WidgetState
    extends State<Calculatepricesingleyaldiz47Widget> {
        ...
        leading: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => StandardTripleRoomcityinWidget(),
              ),
            );
          },
          child: Icon(
