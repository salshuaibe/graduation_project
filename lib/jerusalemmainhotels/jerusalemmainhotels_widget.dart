...
class JerusalemmainhotelsWidget extends StatefulWidget {
  JerusalemmainhotelsWidget({Key key}) : super(key: key);

  @override
  _JerusalemmainhotelsWidgetState createState() =>
      _JerusalemmainhotelsWidgetState();
}

class _JerusalemmainhotelsWidgetState extends State<JerusalemmainhotelsWidget> {
