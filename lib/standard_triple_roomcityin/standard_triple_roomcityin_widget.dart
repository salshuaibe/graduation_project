import '../calculatepricesingleyaldiz47/calculatepricesingleyaldiz47_widget.dart';
...
class StandardTripleRoomcityinWidget extends StatefulWidget {
  StandardTripleRoomcityinWidget({Key key}) : super(key: key);

  @override
  _StandardTripleRoomcityinWidgetState createState() =>
      _StandardTripleRoomcityinWidgetState();
}

class _StandardTripleRoomcityinWidgetState
    extends State<StandardTripleRoomcityinWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz47Widget(),
                  ),
                );
              },
              child: Icon(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      Image.asset(
                                        'assets/images/133574282.jpg',
                                        width: 60,
                                        height: 600,
                                        fit: BoxFit.contain,
                                      ),
                                      Image.asset(
                                        'assets/images/133575461.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
