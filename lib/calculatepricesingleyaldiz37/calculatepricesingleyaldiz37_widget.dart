...
class Calculatepricesingleyaldiz37Widget extends StatefulWidget {
  Calculatepricesingleyaldiz37Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz37WidgetState createState() =>
      _Calculatepricesingleyaldiz37WidgetState();
}

class _Calculatepricesingleyaldiz37WidgetState
    extends State<Calculatepricesingleyaldiz37Widget> {
        ...
        leading: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => StandardTripleRoomcasablancaWidget(),
              ),
            );
          },
          child: Icon(
