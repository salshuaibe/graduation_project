...
class CheckavailabilityplazaWidget extends StatefulWidget {
  CheckavailabilityplazaWidget({Key key}) : super(key: key);

  @override
  _CheckavailabilityplazaWidgetState createState() =>
      _CheckavailabilityplazaWidgetState();
}

class _CheckavailabilityplazaWidgetState
    extends State<CheckavailabilityplazaWidget> {
