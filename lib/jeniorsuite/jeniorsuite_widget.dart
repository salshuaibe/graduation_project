import '../calculatepricesingleyaldiz7/calculatepricesingleyaldiz7_widget.dart';
...
class JeniorsuiteWidget extends StatefulWidget {
  JeniorsuiteWidget({Key key}) : super(key: key);

  @override
  _JeniorsuiteWidgetState createState() => _JeniorsuiteWidgetState();
}

class _JeniorsuiteWidgetState extends State<JeniorsuiteWidget> {
          ...
          InkWell(
            onTap: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Calculatepricesingleyaldiz7Widget(),
                ),
              );
            },
            child: Icon(
