...
class Calculatepricesingleyaldiz18Widget extends StatefulWidget {
  Calculatepricesingleyaldiz18Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz18WidgetState createState() =>
      _Calculatepricesingleyaldiz18WidgetState();
}

class _Calculatepricesingleyaldiz18WidgetState
    extends State<Calculatepricesingleyaldiz18Widget> {
