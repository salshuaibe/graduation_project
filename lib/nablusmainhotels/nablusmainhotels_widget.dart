...
class NablusmainhotelsWidget extends StatefulWidget {
  final User user ;
  NablusmainhotelsWidget({Key key,@required  this.user}) : super(key: key);

  @override
  _NablusmainhotelsWidgetState createState() => _NablusmainhotelsWidgetState();
}

class _NablusmainhotelsWidgetState extends State<NablusmainhotelsWidget> {
                                        ...
                                        child: InkWell(
                                          onTap: () async {
                                            await Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    SaleemafandiWidget(user:this.widget.user),
                                              ),
                                            );
                                          },
                                          child: Icon(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          await Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  AlYasmeenHotelsWidget(user: this.widget.user),
                                            ),
                                          );
                                        },
                                        child: Icon(
