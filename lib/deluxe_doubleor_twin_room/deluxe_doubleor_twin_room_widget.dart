import '../calculatepricesingleyaldiz9/calculatepricesingleyaldiz9_widget.dart';
...
class DeluxeDoubleorTwinRoomWidget extends StatefulWidget {
  DeluxeDoubleorTwinRoomWidget({Key key}) : super(key: key);

  @override
  _DeluxeDoubleorTwinRoomWidgetState createState() =>
      _DeluxeDoubleorTwinRoomWidgetState();
}

class _DeluxeDoubleorTwinRoomWidgetState
    extends State<DeluxeDoubleorTwinRoomWidget> {
          ...
          InkWell(
            onTap: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Calculatepricesingleyaldiz9Widget(),
                ),
              );
            },
            child: Icon(
