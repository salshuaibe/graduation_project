...
class HebronmainhotelsWidget extends StatefulWidget {
  HebronmainhotelsWidget({Key key}) : super(key: key);

  @override
  _HebronmainhotelsWidgetState createState() => _HebronmainhotelsWidgetState();
}

class _HebronmainhotelsWidgetState extends State<HebronmainhotelsWidget> {
