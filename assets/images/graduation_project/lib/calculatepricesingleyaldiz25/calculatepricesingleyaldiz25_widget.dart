...
class Calculatepricesingleyaldiz25Widget extends StatefulWidget {
  Calculatepricesingleyaldiz25Widget({Key key}) : super(key: key);

  @override
  _Calculatepricesingleyaldiz25WidgetState createState() =>
      _Calculatepricesingleyaldiz25WidgetState();
}

class _Calculatepricesingleyaldiz25WidgetState
    extends State<Calculatepricesingleyaldiz25Widget> {
