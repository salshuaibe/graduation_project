...
import '../calculatepricesingleyaldiz21/calculatepricesingleyaldiz21_widget.dart';
...
class AlYasmeenBudgetSingleRoomWidget extends StatefulWidget {
  AlYasmeenBudgetSingleRoomWidget({Key key}) : super(key: key);

  @override
  _AlYasmeenBudgetSingleRoomWidgetState createState() =>
      _AlYasmeenBudgetSingleRoomWidgetState();
}

class _AlYasmeenBudgetSingleRoomWidgetState
    extends State<AlYasmeenBudgetSingleRoomWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz21Widget(),
                  ),
                );
              },
              child: Icon(
