import '../calculatepricesingleyaldiz3/calculatepricesingleyaldiz3_widget.dart';
...
class DeluxeQuadrupleRoomWidget extends StatefulWidget {
  DeluxeQuadrupleRoomWidget({Key key}) : super(key: key);

  @override
  _DeluxeQuadrupleRoomWidgetState createState() =>
      _DeluxeQuadrupleRoomWidgetState();
}

class _DeluxeQuadrupleRoomWidgetState extends State<DeluxeQuadrupleRoomWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz3Widget(),
                  ),
                );
              },
              child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/219356725.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356738.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
