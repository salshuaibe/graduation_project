import '../calculatepricesingleyaldiz2/calculatepricesingleyaldiz2_widget.dart';
...
class DeluxeTripleRoomWidget extends StatefulWidget {
  DeluxeTripleRoomWidget({Key key}) : super(key: key);

  @override
  _DeluxeTripleRoomWidgetState createState() => _DeluxeTripleRoomWidgetState();
}

class _DeluxeTripleRoomWidgetState extends State<DeluxeTripleRoomWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz2Widget(),
                  ),
                );
              },
              child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/219356690.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/219356912.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
