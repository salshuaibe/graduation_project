import '../calculatepricesingleyaldiz117/calculatepricesingleyaldiz117_widget.dart';
...
class LargedoubleroomsaleemWidget extends StatefulWidget {
  LargedoubleroomsaleemWidget({Key key}) : super(key: key);

  @override
  _LargedoubleroomsaleemWidgetState createState() =>
      _LargedoubleroomsaleemWidgetState();
}

class _LargedoubleroomsaleemWidgetState
    extends State<LargedoubleroomsaleemWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz117Widget(),
                  ),
                );
              },
              child: Icon(
                                ...
                                Padding(
                                  ...
                                  child: PageView(
                                    ...
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/78258124.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542149.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542207.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542462.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542470.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
                                      Image.asset(
                                        'assets/images/78542545.jpg',
                                        width: 100,
                                        height: 100,
                                        fit: BoxFit.cover,
                                      ),
