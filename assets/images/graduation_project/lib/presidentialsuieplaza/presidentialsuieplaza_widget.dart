import '../calculatepricesingleyaldiz26/calculatepricesingleyaldiz26_widget.dart';
...
class PresidentialsuieplazaWidget extends StatefulWidget {
  PresidentialsuieplazaWidget({Key key}) : super(key: key);

  @override
  _PresidentialsuieplazaWidgetState createState() =>
      _PresidentialsuieplazaWidgetState();
}

class _PresidentialsuieplazaWidgetState
    extends State<PresidentialsuieplazaWidget> {
            ...
            child: InkWell(
              onTap: () async {
                await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Calculatepricesingleyaldiz26Widget(),
                  ),
                );
              },
              child: Icon(
