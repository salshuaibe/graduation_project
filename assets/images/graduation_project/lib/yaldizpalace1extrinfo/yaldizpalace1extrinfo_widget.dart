...
class Yaldizpalace1extrinfoWidget extends StatefulWidget {
  Yaldizpalace1extrinfoWidget({Key key}) : super(key: key);

  @override
  _Yaldizpalace1extrinfoWidgetState createState() =>
      _Yaldizpalace1extrinfoWidgetState();
}

class _Yaldizpalace1extrinfoWidgetState
    extends State<Yaldizpalace1extrinfoWidget> {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          'All guest rooms come with air conditioning, a flat-screen TV with satellite channels, a kettle, a bidet, a hairdryer and a desk. Featuring a private bathroom with a shower and free toiletries, rooms at the hotel also feature a mountain view. At Yaldiz Palace Hotel the rooms come with a seating area.',
