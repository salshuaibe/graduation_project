...
class JerichomainhotelsWidget extends StatefulWidget {
  JerichomainhotelsWidget({Key key}) : super(key: key);

  @override
  _JerichomainhotelsWidgetState createState() =>
      _JerichomainhotelsWidgetState();
}

class _JerichomainhotelsWidgetState extends State<JerichomainhotelsWidget> {
